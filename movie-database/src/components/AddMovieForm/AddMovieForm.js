    ...
    return(
        <div className={styles.container}>
            <section className={styles.form}>
                ...
                <input className={styles.form__input} type="text" id="title"  /><br />
                <label className={styles.form__year} for="text">Year</label><br />
                <input className={styles.form__input} type="text" id="text" /><br /><br />
